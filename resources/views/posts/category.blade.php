    ...
    <div class="max-w-5xl mx-auto px-2 sm:px-6 lg:px-8 py-8">
        ...
        @if ( $category->slug == 'ingenieria-mecanica' )
            ...
            <div class="lg:flex-1 p-8">
                <a href="#" class="uppercase tracking-wide text-3xl text-indigo-500 font-semibold">mecanica</a>
                <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">Respondable Ing. Giovani Branco</a>
        ...
        @elseif( $category->slug == 'ingenieria-electronica' )
            ...
            <div class="lg:flex-1 p-8">
                <a href="#" class="uppercase tracking-wide text-3xl text-indigo-500 font-semibold">electronica</a>
                <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">Respondable Ing. Carlos Grande</a>
                <p class="mt-2 text-gray-500">Getting a new business off the ground is a lot of hard work. Here are five ideas you can use to find your first customers.</p>
            </div>
            ...
            @elseif( $category->slug == 'ingenieria-sistemas' )
                ...
                <div class="lg:flex-1 p-8">
                    <a href="#" class="uppercase tracking-wide text-3xl text-indigo-500 font-semibold">sistemas</a>
                    <a href="#" class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">Respondable Ing. Milder Zanavria</a>
                    <p class="mt-2 text-gray-500">Rama interdisciplinaria de la ingeniería que permite estudiar y comprender la realidad, con el propósito de implementar u optimizar sistemas complejos.</p>
                </div>
